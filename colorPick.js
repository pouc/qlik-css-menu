...
$.widget( "evol.colorpicker", {
	...
	_paletteHTML: function() {
		...
		var h='<div class="evo-pop'+_ie+' ui-evo-widget ui-evo-widget-content ui-evo-corner-all"'+
	...
	_paletteHTML1: function() {
		var opts=this.options,
			...
			oTRTH='<tr><th colspan="10" class="ui-evo-widget-content">';
	...
	_switchPalette: function(link) {
		if(this._enabled){
			...
			if($(link).hasClass('evo-hist')){
				// history
				var h=['<table class="evo-palette"><tr><th class="ui-evo-widget-content">',
